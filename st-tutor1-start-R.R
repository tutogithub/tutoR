...
help(plot)
#q()
#save.image("C:\\Users\\laminehammé\\Desktop\\2. R intro\\st-tutor1-start-R")
#help'plot)
;
help(plot)
...
save.image("C:\\Users\\laminehammé\\Desktop\\2. R intro\\st-tutor1-start-R.RData")
quit()
# test tranfert vers GITHUB